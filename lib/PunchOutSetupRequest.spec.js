...
describe('the "PunchOutSetupRequest" module', function () {
  ...
  describe('the instance members specific for this class', function () {
    ...
    describe('the "setBuyerInfo" method', function () {
      it('must accept undefined values', function () {
        expect(() => {
          instance.setBuyerInfo({ domain: undefined, id: undefined })
        }).to.not.throw()
      })
    })

    describe('the "setSupplierInfo" method', function () {
      it.only('must accept undefined values', function () {
        expect(() => {
          instance.setSupplierInfo({ domain: undefined, id: undefined })
        }).to.not.throw()
      })
    })
    ...
    describe('the "setSenderInfo" method', function () {
      it.only('must accept undefined values', function () {
        expect(() => {
          instance.setSenderInfo({ domain: undefined, id: undefined, secret: undefined })
        }).to.not.throw()
      })
    })
