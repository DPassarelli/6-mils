...
describe('the "PunchOutSetupResponse" module', function () {
  ...
  describe('the instance members', function () {
    ...
    context('for a failed response', function () {
      /**
       * To reduce boilerplate code, a shared instance is used for each test,
       * which gets reset before each one.
       * @type {Object}
      ...
      describe('statusText', function () {
        context('when there is text within the "<Status>" element', function () {
          it('must match the value of that text', function () {
        ...
        context('when there is not any text within the "<Status>" element', function () {
          it('must match the value of the specified "text" attribute', function () {
            const alteredCXML = sourceXml.replace(/>.+<\/Status>/, '></Status>')
            const newInstance = new T(alteredCXML)

            const expected = 'failure'
            const actual = newInstance.statusText
