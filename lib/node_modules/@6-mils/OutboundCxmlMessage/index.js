 ...
 *                         for this message.
 */
class OutboundCxmlMessage {
  constructor (type, options) {
    type = type || {}

    if (!~Object.keys(messageTypeEnum).indexOf(type.description)) {
      throw new Error('The constructor for OutboundCxmlMessage reqiures a value from OutboundCxmlMessage.MESSAGE_TYPES.')
    }

    Object.defineProperty(this, '_type', { value: type.description, writable: false })
  ...
  setBuyerInfo (options) {
    ...
    baseProps.from = mergeInto(options, baseProps.from)
  ...
  setSupplierInfo (options) {
    ...
    const baseProps = _private.get(this)
    baseProps.to = mergeInto(options, baseProps.to)
    _private.set(this, baseProps)
  ...
  setSenderInfo (options) {
    ...
    const baseProps = _private.get(this)
    baseProps.sender = mergeInto(options, baseProps.sender)
    _private.set(this, baseProps)
  ...
  /**
   * [_getGenericResponse description]
   * @return {[type]} [description]
   */
  _getGenericResponse () {
    switch (this._type) {
